...
curl -k --cacert whoami/cert/kamching.freemyip.com/ca.crt --cert whoami/cert/kamching.freemyip.com/client.crt --key whoami/cert/kamching.freemyip.com/client.key https://whoami.kamching.freemyip.com:1443
